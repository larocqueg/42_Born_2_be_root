...
Improvements / Potential Issues:
    ...
    Disk Information Calculation: The pdisk calculation might have a bug with the format. It uses df -BM (MB), but ft is calculated in GB in the fdisk variable. This might create inconsistency unless you standardize the units. Consider using consistent units for both fdisk and udisk.
